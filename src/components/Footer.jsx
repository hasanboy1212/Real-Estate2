...
const Footer = () => {
  return (
    <footer className="max-padd-container mb-4">
      <div  className="max-padd-container bg-primary rounded-tr-3xl pt-12 xl:pt-20 pb-8">
        ...
        <div className="flex justify-between flex-wrap gap-x-2 gap-y-8">
          <div className="max-w-sm">
            ...
            <p className="py-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Placeat, iusto ab unde rem illo molestias officia.</p>
      ...
      {/* copyright */}
      <p className="text-white bg-white bg-tertiary medium-14 py-2 px-8 rounded-b-3xl flexBetween"><span>2024 CasaCentral</span>All rights reserved</p>
    </footer>
  )
}
